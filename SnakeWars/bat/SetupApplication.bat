...
:: Android packaging
set AND_CERT_NAME="SnakeWars"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SnakeWars.p12
...
set IOS_PROVISION=cert\SnakeWars.mobileprovision
...
set APP_ID=air.SnakeWars

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SnakeWars
